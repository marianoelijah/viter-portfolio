...
const ModalAddBanner = ({ itemEdit }) => {
  ...
  const initVal = {
    ...
    banner_price: itemEdit ? itemEdit.banner_price : "",
    banner_category_id: itemEdit ? itemEdit.banner_category_id : "",
  };

  const yupSchema = Yup.object({
    banner_title: Yup.string().required("Required"),
    banner_price: Yup.string().required("Required"),
    banner_category_id: Yup.string().required("Required"),
  });
