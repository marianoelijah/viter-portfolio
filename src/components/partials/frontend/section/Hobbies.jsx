        ...
        <div className="hobbies-wrapper flex justify-between">
          <div className="hobbies-image relative group">
            ...
            <div className="absolute group top-3 left-3 text-black p-3 max-w-[425px] w-full max-h-[425px] h-full rounded-3xl bg-white opacity-0  group-hover:opacity-80">
              ...
              <ul className="flex flex-col gap-5">
                ...
                <li>
                  Fictional stories help me to understand different perspectives
                  and emotions.
                </li>
                <li>It helps me to reduce Stress and Anxiety</li>
                <li>
                  It really helps me to nurtures the mind, body, and soul.{" "}
                </li>
                <li>
                  Its helps me to know more about the fictional stories and
                  making me to think delusional{" "}
                </li>
              </ul>
            </div>
          </div>
          <div className="hobbies-image relative group">
            ...
            <div className="absolute group top-3 left-3 text-black p-3 max-w-[425px] w-full max-h-[425px] h-full rounded-3xl bg-white opacity-0  group-hover:opacity-80">
              ...
              <ul className="flex flex-col gap-5">
                ...
                <li>
                  This images was taken when we go to HongKong to have a family
                  celebration
                </li>
          ...
          <div className="hobbies-image relative group">
            ...
            <div className="absolute group top-3 left-3 text-black p-3 max-w-[425px] w-full max-h-[425px] h-full rounded-3xl bg-white opacity-0  group-hover:opacity-80">
              ...
              <ul className="flex flex-col gap-5">
                <li>
                  This photo was taken when we explore the places in HongKong
                  and Macau
                </li>
                <li>
                  I really enjoy taking adventure on any trip that we go, it's
                  really fun
                </li>
