        ...
        <div className="introduction-wrapper flex justify-between">
          <div className="introduction-text text-light   justify-center flex flex-col max-w-[800px]">
            ...
            <p className="text-xl leading-relaxed">
              ...
              college student at Laguna State Polytechnic University. I was 
              born in Makati Medical Center but now currently living in the
              Tiaong Quezon Province. you can call me "Elii" for short
            </p>
          </div>
