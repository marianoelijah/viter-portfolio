        ...
        <div className="aboutme-wrapper flex justify-between">
          <div className="aboutme-image relative group">
            ...
            <div className="absolute group top-3 left-3 text-black p-3 max-w-[425px] w-full max-h-[425px] h-full rounded-3xl bg-white opacity-0  group-hover:opacity-80">
              ...
              <ul className="flex flex-col gap-5">
                ...
                <li>Address: Brgy. Tagbakin, Tiaong, Quezon </li>
              </ul>
            </div>
          </div>
          <div className="aboutme-text text-white max-w-[800px] flex flex-col justify-center text-justify">
            ...
            <p className="leading-relaxed">
              ...
              person and a lot of people see me as a kind and innocent one Yes,
              that is true. but some people treat me like shit so I'm just
              depending my self not to lose to anyone. the thing is when i'm
              getting mad they dont know how capable I am to lure them out, and
              they never know who i really am. Lorem ipsum dolor sit amet
              consectetur adipisicing elit. Iusto adipisci ipsa perspiciatis
              delectus fugit quae, maxime repellendus. Reiciendis alias quis
              magnam recusandae at distinctio atque. Officia impedit perferendis
              distinctio minus incidunt vitae enim deleniti explicabo eum quos
              quae, accusamus, ea nisi reprehenderit hic aspernatur in sequi
              corporis dicta dolorum veniam non laborum esse quod. Quos a
              officia aperiam magni facilis?
            </p>
          </div>
        </div>
      </div>
